<template>
  <section class="work-crev sub-bg">
    <div
      class="container section-padding position-re bord-top-grd bord-bottom-grd"
    >
          ...
          <div>
            ...
            <h3 class="fw-600 fz-50 text-u d-rotate wow">
              <span class="rotate-text">
                Selected <span class="fw-200">Works.</span>
              </span>
            </h3>
          </div>
          <div class="ml-auto">
      ...
      <div class="work-swiper out-right">
        <Swiper loop v-bind="swiperOptions">
          <SwiperSlide
          ...
          >
            <div class="item d-flex align-items-center">
              <div class="cont">
                <h6 class="sub-title main-color mb-15">UI/UX Design</h6>
                <h2>
                  {{ item.title }} <br />
                  {{ item.subTitle }}
                </h2>
